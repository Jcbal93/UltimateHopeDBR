var
	...
	list/CustomCommons=list()
	list/GlobalLandingLocations = list()
	BaseUpdate=1 //Updates...base.
	WorldBaseAmount=1 //sets everyones base to a number....mod...bluh bluh.
	list/NoSagaRaces=list("Saiyan", "Djinn", "Changeling", "Makyo", "Shinjin", "Demon", "Dragon")

	WipeStart//Holds the time (midnight) that the wipe started at. Used to define starting RPP and daily potential.
	DaysOfWipe
	RPPStarting=0//holds the starting value of rpp
	RPPStartingDays=3//holds the number of days you will achieve the starting limit in
	RPPHighest=0//global tracking for the highest amt of rpp
	RPPLimit=2000//This * RPP gain is the maximum RPP able to be acquired by default.  With EC included, this can be x1.5
	RPPDaily=20//This is the amount given daily.
	...
	PotentialDaily=1.15//amount of potential it can be assumed will be gained daily with minimal effort
	RPPBaseMult=1
	MoneyName="Credits"
...
mob/var
	...
	RecovCut=0
	RecovEroded=0
	AngerPoint=25//get angry with this percent of health left

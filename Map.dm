...
turf
	verb
		Select_Turf()
			...
			C.Creates=src.type
			if(istype(src,/turf/CustomTurf))
				var/turf/CustomTurf/CT=src
				usr.CustomTurfIcon=src.icon
				usr.CustomTurfState=src.icon_state
				usr.CustomTurfRoof=CT.Roof
				usr.CustomTurfDensity=src.density
				usr.CustomTurfOpacity=src.opacity
			C.icon=src.icon
	...
	verb
		Select_Object()
			...
			if(istype(src,/obj/Turfs/CustomObj1))
				usr.CustomObj1Icon=src.icon
				usr.CustomObj1State=src.icon_state
				usr.CustomObj1Layer=src.layer
				usr.CustomObj1Density=src.density
...
obj/Turfs/Edges/Attackable=0
obj/Turfs/Surf/Grabbable=0
obj/Turfs/Surf/Attackable=0
...
//Grass turfs
	...
	GrassA1
		...
		SecondaryTurfType="Grass"
	GrassA2
		icon='PlainsGrass.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Grass"
	GrassA3
		icon='True_Plains.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Grass"
	GrassA4
		icon='darkgreenjungle.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Grass"
	GrassA5
		icon='TrueJungle.png'
		...
		SecondaryTurfType="Grass"
	StoneA1
		icon='BrownStoneFloor.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Stone"
	StoneA2
	...
	StoneA7
		...
		SecondaryTurfType="Stone"
	StoneA8
		icon='YellowStoneFloor.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Stone"
	WoodA1Paired1
		icon='PairedWoodTile.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Wood"
	WoodA1Paired2
		icon='PairedWoodTile2.png'
		PrimaryTurfType="Floor"
		SecondaryTurfType="Wood"
	WoodA2
		icon='PaleWood.png'
...
turf/Edges
	...
	Grass24EdgeS
		icon='Grass.dmi'
		icon_state="Grass24EdgeS"
	Grass24EdgeE
		icon='Grass.dmi'
		icon_state="Grass24EdgeE"
	Grass24EdgeW
		icon='Grass.dmi'
		icon_state="Grass24EdgeW"
	Grass24EdgeN
		icon='Grass.dmi'
		icon_state="Grass24EdgeN"
	Grass4EdgeS
		icon='Grass.dmi'
		icon_state="Grass4EdgeS"
	Grass4EdgeE
		icon='Grass.dmi'
		icon_state="Grass4EdgeE"
	Grass4EdgeW
		icon='Grass.dmi'
		icon_state="Grass4EdgeW"
	Grass4EdgeN
		icon='Grass.dmi'
		icon_state="Grass4EdgeN"
	Sand3EdgeN
		icon='Dirt.dmi'
...
obj/Turfs
	...
	Table9
		...
		density=1
	LargeTableL
		icon='Large_Fancy_Table_White.dmi'
		icon_state="Left"
		density=1
	LargeTableM
		icon='Large_Fancy_Table_White.dmi'
	...
	JapanBed
		...
		density=0
		New()
			var/image/A=image(icon='BedJapan.dmi', icon_state="Cover", layer=MOB_LAYER+1)
			src.overlays.Remove(A)
			src.overlays.Add(A)
			..()
	JapanBedPink
		icon='BedJapanPink.dmi'
		layer=MOB_LAYER-1
		pixel_x=-16
		pixel_y=-28
		density=0
		New()
			var/image/A=image(icon='BedJapanPink.dmi', icon_state="Cover", layer=MOB_LAYER+1)
			src.overlays.Remove(A)
			src.overlays.Add(A)
			..()
	Pew_Bible
		...
		density=0
		New()
			var/image/A=image(icon='Pew.dmi', icon_state="Bible", layer=MOB_LAYER+1)
			src.overlays.Remove(A)
			src.overlays.Add(A)
			..()
	Pew_No_Bible
		...
		density=0
		New()
			var/image/A=image(icon='Pew.dmi', icon_state="No Bible", layer=MOB_LAYER+1)
			src.overlays.Remove(A)
			src.overlays.Add(A)
			..()
	Bench
	...
	box2
		...
		density=1
	Laundry_Basket
		icon='BasketLaundry.png'
		density=1
		pixel_x=3
	Full_Laundry_Basket
		icon='BasketLaundryFull.png'
		density=1
		pixel_x=3
	Folded_Laundry_Basket
		icon='BasketLaundryFolded.png'
		density=1
		pixel_x=3
	Wall_Clock
		icon='Clock2.png'
	...
	Lunchroom_Table
		...
		layer=MOB_LAYER+1
		New()
			var/image/a1=image(icon='Table_Lunchroom.dmi', icon_state="Bench", pixel_x=-48, layer=MOB_LAYER-1)
			var/image/a2=image(icon='Table_Lunchroom.dmi', icon_state="Bench", pixel_x=48, layer=MOB_LAYER-1)
			src.overlays.Remove(a1)
			src.overlays.Remove(a2)
			src.overlays.Add(a1)
			src.overlays.Add(a2)
			..()
	Floor_Fern
	...
	Flower_Fern
		...
		density=0
	Flower_Fern_Red
		icon='FlowerFernRed.png'
		pixel_x=0
		pixel_y=0
		layer=4
		density=0
	Jungle_Curved_Tree
		icon='JungleCurvedTree.png'
		pixel_x=-66
		pixel_y=-8
		layer=4
		density=1
	Jungle_Straight_Tree
		icon='JungleStraightTree.png'
		pixel_x=-62
		pixel_y=-13
		layer=4
		density=1
	Jungle_Fluffy_Tree
		icon='JungleFluffyTree.png'
		pixel_x=-50
		pixel_y=-10
		layer=4
		density=1
	Jungle_Palm_Tree
		icon='JunglePalmTree.png'
		pixel_x=-16
		pixel_y=-4
		layer=4
		density=1
...
obj/Special
	...
	Teleporter2
		New()
			...
			//src.transform*=1.5
		Del()
			if(src.AssociatedWarper)
				del src.AssociatedWarper
			..()
		density=1
		Grabbable=0
